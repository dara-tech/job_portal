...
const Job = ({ job }) => {
  ...
  return (
<div className="relative px-2 py-2 lg:py-6 md:py-6 md:px-6 lg:px-6 bg-white dark:bg-gray-800 ring-1 ring-gray-300 dark:ring-gray-700 shadow-md hover:shadow-lg rounded-lg transition-shadow duration-300">
